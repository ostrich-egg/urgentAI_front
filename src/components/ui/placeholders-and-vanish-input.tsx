  ...
  return (
    ...
    >
      ...
      <button
        disabled={!value}
        type="submit"
        className="absolute right-2 top-1/2  -translate-y-1/2 h-8 w-8 rounded-full disabled:bg-gray-100 bg-black   transition duration-200 flex items-center justify-center"
      >
        <motion.svg
